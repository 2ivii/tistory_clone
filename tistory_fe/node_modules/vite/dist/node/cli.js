...
import { D as colors, E as bindShortcuts, x as createLogger, h as resolveConfig } from 'vite/dist/node/chunks/dep-827b23df.js';
import { VERSION } from 'vite/dist/node/constants.js';
...
cli
    ...
    // is ok here
    const { createServer } = await import('vite/dist/node/chunks/dep-827b23df.js').then(function (n) { return n.J; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { build } = await import('vite/dist/node/chunks/dep-827b23df.js').then(function (n) { return n.I; });
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { optimizeDeps } = await import('vite/dist/node/chunks/dep-827b23df.js').then(function (n) { return n.H; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { preview } = await import('vite/dist/node/chunks/dep-827b23df.js').then(function (n) { return n.K; });
    try {
